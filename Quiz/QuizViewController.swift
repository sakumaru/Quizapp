...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        quizArray.append(["問題文1 以下のドリンクの中でホイップがのっていないものはどれ？","カフェラテ","チョコラテ","キャラメルラテ",1])
        ...
        quizArray.append(["問題文4　以下の選択肢の中でイタリア語で「元気よく」の意味にあたるものはどれか","コン　アモーレ","コン　ブリオ","コン　スプリトゥオ",3])
        quizArray.append(["問題文5 タリーズコーヒーの店員が決して言わないものはどれか","少々お持ちください","またお待ちしております","いらっしゃいませ",3])
